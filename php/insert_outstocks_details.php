...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['productId']) && isset($_POST['outQuantity']) && isset($_POST['empid'])) {
    $productId = $_POST['productId'];
    $outQuantity = $_POST['outQuantity'];
    $empid = $_POST['empid'];

    // Perform database update based on action (add/subtract)
    $sql = "INSERT INTO outstocks_details (product_id, out_qnt, received_date, empid) VALUES ($productId, $outQuantity, CURDATE(), $empid)";
